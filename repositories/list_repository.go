...
type ListRepository interface {
	...
	UpdatePosition(boardPublicID, position []string) error
...
func (r *listRepository) UpdatePosition(boardPublicID, position []string) error {
	return config.DB.Model(&models.ListPosition{}).
		...
		Update("list_position", position).Error
}
